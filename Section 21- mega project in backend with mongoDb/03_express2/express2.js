...
//this above code is good but it will fail in deployment(digitalocean) as The port is hardcoded to 3000. This limits flexibility in deployment environments where the port might be dynamically assigned (e.g., in cloud services or containerized environments).
//using dotenv

//create a env file and write port = 3000
